              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('access')}>
                    <Translate contentKey="cmpAdminPortalApp.role.access">Access</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {roleList.map((role, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{role.role}</td>
                    <td>
                      <Translate contentKey={`cmpAdminPortalApp.Access.${role.access}`} />
                    </td>
