            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="cmpAdminPortalApp.costManagementPlatform.hb">Hb</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {costManagementPlatformList.map((costManagementPlatform, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      {costManagementPlatform.hb ? (
                        <Link to={`hb/${costManagementPlatform.hb.id}`}>{costManagementPlatform.hb.id}</Link>
                      ) : (
                        ''
                      )}
                    </td>
