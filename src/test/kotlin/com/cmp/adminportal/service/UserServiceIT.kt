...
import com.cmp.adminportal.config.ANONYMOUS_USER
import com.cmp.adminportal.config.DEFAULT_LANGUAGE
import com.cmp.adminportal.config.TestSecurityConfiguration
import com.cmp.adminportal.domain.User
import com.cmp.adminportal.repository.UserRepository
import com.cmp.adminportal.security.ANONYMOUS
...
class UserServiceIT {
    ...
    private fun createMockOAuth2AuthenticationToken(userDetails: Map<String, Any?>): OAuth2AuthenticationToken {
        ...
        val usernamePasswordAuthenticationToken = UsernamePasswordAuthenticationToken(ANONYMOUS_USER, ANONYMOUS_USER, authorities)
